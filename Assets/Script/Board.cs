...
public class Board : MonoBehaviour
{
    ...
    {
        var piece = Instantiate(redPrefab, createPos, Quaternion.identity).GetComponent<Piece>();
        _ = Instantiate(bluePrefab, createPos, Quaternion.identity).GetComponent<Piece>();
